<script lang="ts">
	...
	import { theme, notifications } from '$lib/stores';
...
{:else if !setupChecked}
	...
	<div class="min-h-screen bg-[var(--ctp-base)] flex items-center justify-center">
		<div class="text-center">
			...
			<p class="mt-2 text-[var(--ctp-overlay1)]">Loading...</p>
		</div>
	</div>
{:else}
	...
	<div class="min-h-screen bg-[var(--ctp-base)] text-[var(--ctp-text)]">
		...
		<aside class="fixed top-14 left-0 bottom-0 w-56 bg-[var(--ctp-mantle)] border-r border-[var(--ctp-surface0)]">
			<nav class="p-4 space-y-1">
				...
				<div class="pt-4 pb-2">
					<span class="px-3 text-xs font-medium text-[var(--ctp-overlay1)] uppercase tracking-wider">Config</span>
				</div>
				...
				<a href="/config/backup" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[var(--ctp-surface0)] text-[var(--ctp-subtext1)] hover:text-[var(--ctp-text)] transition-colors">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				<a href="/config/app" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[var(--ctp-surface0)] text-[var(--ctp-subtext1)] hover:text-[var(--ctp-text)] transition-colors">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				<div class="pt-4 pb-2">
					<span class="px-3 text-xs font-medium text-[var(--ctp-overlay1)] uppercase tracking-wider">Monitor</span>
				</div>
