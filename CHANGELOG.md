...
- **Главная: разбивка рядом с графиком, CPU и память в подвале (#101).** Справа
  ...
  же период, что и график: 1 ч и 24 ч по истории,
  которая приходит в том же ответе, что и сам график, так что ни одного нового
  запроса; на 60 с это открытые прямо сейчас соединения, каждое со своего начала
  (как «сейчас» в «Разбивке») — так и подписано, чтобы не путать с окном графика.
  Список держит постоянную высоту, поэтому переключение ничего не двигает. CPU и память переехали в подвал к тоталам и диску; у CPU остался
  спарклайн 40×12 — всплеск и есть то, ради чего на него смотрят. Наведение на
  график показывает время и обе скорости в этой точке: плашка встаёт в конец
  строки легенды, на место подписи периода, а не бегает за курсором, закрывая
  разбираемую линию.
